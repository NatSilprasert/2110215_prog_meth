...
public class TestLeaderUnitCard {
    ...
    @Test
    void testAttack() {
        int attackDamage1 = leaderUnit1.attackUnit(oppoUnit1);
        assertEquals(2, oppoUnit1.getHealth());
        assertEquals(3, attackDamage1);

        int attackDamage2 = leaderUnit2.attackUnit(oppoUnit1);
        assertEquals(1, oppoUnit1.getHealth());
        assertEquals(1, attackDamage2);

        int attackDamage3 = leaderUnit3.attackUnit(oppoUnit1);
        assertEquals(1, oppoUnit1.getHealth());
        assertEquals(0, attackDamage3);

        int attackDamage4 = leaderUnit1.attackUnit(oppoUnit1);
        assertEquals(0, oppoUnit1.getHealth());
        assertEquals(1, attackDamage4);
    }
    ...
    void testBuffUnit() {
        ...
        assertEquals(4, unitList[0].getHealth());
        assertEquals(3, unitList[1].getHealth());
        assertEquals(6, unitList[2].getHealth());

        assertEquals(4, unitList[0].getPower());
        assertEquals(6, unitList[1].getPower());
        assertEquals(5, unitList[2].getPower());
